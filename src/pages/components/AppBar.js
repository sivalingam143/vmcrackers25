              ...
              <Row className="py-0">
                ...
                <Col lg="8" className="align-self-center ">
                  <Marquee
                    ...
                    delay={9}
                  >
                    💥 "வெடி வெடிக்க வேண்டாமா? அப்போ நேரா வா – சிவகாசி MERWIN
                    Crackers Shop கு வா! சலுகை கண்ணை மூட வைக்கும், விலை பைய
                    எடுத்துவைக்கும்!" 🎆 "ஒரே ஷாப்புல வாங்குறீங்க, அனைத்து வகை
                    வெடிகளும் கிடைக்குது! தீபாவளிக்கு தீபமா வெடிக்கணும்னா –
                    MERWIN கு வா தம்பி!"(99424 16562)
                  </Marquee>
                </Col>
              </Row>
            </Container>
...
const AppBarFour = () => {
  ...
  <div className="address-box">
    <h5 className="bold"> Address</h5>
    <p className="regular">Peranayakkanpatti, Sivakasi, Tamil Nadu 626128</p>
  </div>
</Col>
